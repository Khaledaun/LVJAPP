...
# Version 3.1 — Enhanced Architecture + Full Feature Spec + Agent Operating System
...
2. Run the audit commands in Phase 0
3. Research the design references listed in Phase 1
4. Check existing code in `AssistantAPP-main/` to understand current patterns
5. Only then begin Sprint 0
...
*LVJ AssistantApp CLAUDE.md — v3.1 — Updated April 2026*
*Do not edit this file during a coding session.
 Update it only when architecture decisions change.*
